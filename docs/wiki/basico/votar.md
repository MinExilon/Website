...
Votar por el servidor nos ayuda a tener mayor visibilidad en páginas de servidores, logrando que más gente pueda descubrirnos y entrar a jugar.

Eso sí, no solo es una ventaja para los nuevos usuarios, sino también para __tí__, ya que al votar consigues varios tipos de __recompensas__.

## Cómo votar

Para votar debes entrar en las páginas web donde se ha registrado el servidor de MinExilon y seguir los pasos de cada sitio para registrar el voto.

<div class="grid cards" markdown>

-   [:lucide-vote:{ .lg .middle } &nbsp; __ServidoresDeMinecraft__](https://servidoresdeminecraft.es/server/vote/bd3TkA/play.minexilon.com)

-   [:lucide-vote:{ .lg .middle } &nbsp; __PlanetMinecraft__](https://www.planetminecraft.com/server/las-valkirias-3319200/)

-   [:lucide-vote:{ .lg .middle } &nbsp; __Minecraft MP__](https://minecraft-mp.com/server-s197938)
...
También puedes consultar los enlaces dentro del servidor con el comando `/votar` o `/vote`.
...
Cada 50 votos que se registren globalmente aparecerá una __piñata__ en el spawn!!

<figure markdown="span">
  ![Piñata](https://img.minexilon.com/wiki/votos/votos_pinata.webp)
  <figcaption>Fiesta de la piñata en el spawn de mundo Ciudades.</figcaption>
</figure>
