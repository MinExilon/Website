...
-   ## :material-pickaxe:{ .middle } __Minería__
    ...
    Recurso: <span class="tag-econ-gemas">gemas</span>
...
-   ## :material-axe:{ .middle } __Tala__
    ...
    Recurso: <span class="tag-econ-ramas">ramas</span>
...
-   ## :material-bow-arrow:{ .middle } __Caza__
    ...
    Recurso: <span class="tag-econ-colmillos">colmillos</span>
...
-   ## :material-fish:{ .middle } __Pesca__
    ...
    Recurso: <span class="tag-econ-escamas">escamas</span>
...
Cada trabajo tiene una caja especial en la que te pueden tocar premios interesantes como <span class="tag-econ-dracmas">dracmas</span>, mapas del cartógrafo, libros de encantamiento o boosts.

Las cajas se encuentran ubicadas en el spawn de Exilon, al que puedes acceder vía `/spawn`.
Para abrir cada caja, necesitas pagar una cantidad del recurso correspondiente.

!!! tip "Probabilidad de cada premio"
    Consulta el % de probabilidad de cada premio dentro del servidor, en la información de la caja especial usando el clic derecho.
